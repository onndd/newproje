...
def add_target_columns(df):
    ...
    # We define 'Crash' as anything less than our SAFE ZONE (1.40x).
    # This gives the model more examples of "Bad Situations" to learn from.
    df['target_crash'] = (vals < 1.40).astype(int)
